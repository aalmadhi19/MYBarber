...
return [
    ...
    */
    ...
    'required_unless'      => ':attribute مطلوب في حال ما لم يكن :other معهد الإدارة.',
    ...
    */
    ...
    'custom' => [
        ...
        'phone' => [
            ...
            'starts_with' =>'يبدأ رقم الجوال ب 05',
            'max' =>'رقم الجوال مكون من ١٠ خانات',
            'unique' =>'رقم الجوال مستخدم ب الفعل',

        ],
        'email' => [
            'required' =>'البريد الإلكتروني مطلوب',
            'unique' =>'البريد الإلكتروني مستخدم ب الفعل',
